# Trail photo attribution

The application stores these files locally so seeded trail pages do not depend
on a live image service. The copies in this directory were resized for web use;
their subjects were not altered.

| Local file | Subject | Creator | License | Source |
| --- | --- | --- | --- | --- |
| `matka_canyon_skopje_3.jpg` | Matka Canyon | Kallerna | [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Matka_Canyon_Skopje_3.jpg) |
| `matka2_view_1.jpg` | Matka Canyon from the Sveta Petka dam road | Kallerna | [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Matka2_view_1.jpg) |
| `titov_vrv_a_turcin.jpg` | Titov Vrv and Mal Turčin | Pavouk | [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/) | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Titov_vrv_a_Turcin.jpg) |
...
| `vodno-millennium-cross.jpg` | Millennium Cross on Vodno | Quahadi Añtó | [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/) | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Milenijski_križ.,Vodno.07058.JPG) |
